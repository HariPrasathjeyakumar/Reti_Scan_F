...
TEXT_MUTED   = "#9ca3af"        # Muted silver gray text
TEXT_FAINT   = "#6b7280"        # Faint text
ACCENT       = "#1f93e0"        # Cyan/Sky blue primary accent
...
st.markdown(f"""
    ...
    .rs-hero-title {{ font-size: 26px; font-weight: 800; letter-spacing: -0.5px; color: {TEXT_MAIN}; }}
